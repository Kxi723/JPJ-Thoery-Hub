<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RoadScenario.aspx.cs" Inherits="JPJ_Theory_Hub.RoadScenario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DatabaseForAssignmentConnectionString1 %>" 
        SelectCommand="SELECT * FROM [QuestionBankTable] WHERE [QuizID] = 2">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DatabaseForAssignmentConnectionString1 %>"
        InsertCommand="INSERT INTO [StudyLog] ([UserID], [QuizID], [lastQuestion], [lastViewed]) VALUES (@UserID, @QuizID, @lastQuestion, @lastViewed)"
        UpdateCommand="UPDATE [StudyLog] SET [lastQuestion] = @lastQuestion, [lastViewed] = @lastViewed WHERE [UserID] = @UserID AND [QuizID] = @QuizID">
        <InsertParameters>
            <asp:SessionParameter Name="UserID" SessionField="UserID" Type="Int32" />
            <asp:Parameter Name="QuizID" Type="Int32" />
            <asp:Parameter Name="lastQuestion" Type="Int32" />
